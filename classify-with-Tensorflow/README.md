...
[Inception-v3](https://www.tensorflow.org/tutorials/image_recognition) model (Google's convolutional neural network, CNN) is retrained on a 4 classes ground truth datasets (picture, drawing, map, filter). (The Inception model is downloaded directly from the retrain.py script.)

The [dataset](https://github.com/altomator/Introduction_to_Deep_Learning/edit/master/classify-with-Tensorflow/images) includes 4 classes of 20 images extracted from Gallica.
